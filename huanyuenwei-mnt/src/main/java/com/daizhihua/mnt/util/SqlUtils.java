...
import com.daizhihua.mnt.enums.DataTypeEnum;
...
public class SqlUtils {
	...
	private static DataSource getDataSource(String jdbcUrl, String userName, String password) {
		...
		if (!map.containsKey(key) || null == map.get(key)) {
			...
			// 配置获取连接等待超时的时间
			druidDataSource.setMaxWait(300);
			// 配置初始化大小、最小、最大
    ...
    public static HashMap runSql(String jdbcUrl, String userName, String password,String sql) {
        String msg = "error";
        String sHead = "";
